...
final List<Education> educationList = [
  Education(
    description:
        'Curso de Flutter pela Cod3r. Meu primeiro curso sobre programação, assim sendo o Dart meu primeiro contato com desenvolvimento de aplicações.',
    linkName: 'www.cod3r.com.br',
    linkCertificate:
        'https://www.udemy.com/certificate/UC-8a060972-2613-44d1-af56-b719c51c8f4e/',
    period: '2021',
  ),
  Education(
    description:
